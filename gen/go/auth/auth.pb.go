...
func (x *GetChatTokenRequest) GetAuthToken() string {
	if x != nil {
		return x.AuthToken
	}
	return ""
...
func (x *GetChatTokenResponse) GetChatToken() string {
	if x != nil {
		return x.ChatToken
	}
	return ""
...
const file_auth_proto_rawDesc = "" +
	...
	"\x13GetChatTokenRequest\x12\x1d\n" +
	"\n" +
	"auth_token\x18\x01 \x01(\tR\tauthToken\"5\n" +
	"\x14GetChatTokenResponse\x12\x1d\n" +
	"\n" +
	"chat_token\x18\x01 \x01(\tR\tchatToken2\xef\x01\n" +
	"\x04Auth\x129\n" +
	...
	"\fGetChatToken\x12\x19.auth.GetChatTokenRequest\x1a\x1a.auth.GetChatTokenResponseB\x1aZ\x18simplechat.auth.v1;auth1b\x06proto3"
...
var file_auth_proto_goTypes = []any{
	...
	(*GetChatTokenRequest)(nil),  // 6: auth.GetChatTokenRequest
	(*GetChatTokenResponse)(nil), // 7: auth.GetChatTokenResponse
}
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.Logout:input_type -> auth.LogoutRequest
	6, // 3: auth.Auth.GetChatToken:input_type -> auth.GetChatTokenRequest
	...
	7, // 7: auth.Auth.GetChatToken:output_type -> auth.GetChatTokenResponse
